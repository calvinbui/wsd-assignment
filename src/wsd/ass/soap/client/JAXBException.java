...
public class JAXBException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private wsd.ass.soap.client.StackTraceElement[] linkedException;
    ...
    public JAXBException(
           ...
           wsd.ass.soap.client.StackTraceElement[] linkedException,
     ...
     */
    public wsd.ass.soap.client.StackTraceElement[] getLinkedException() {
        return linkedException;
    }
     ...
     */
    public void setLinkedException(wsd.ass.soap.client.StackTraceElement[] linkedException) {
        this.linkedException = linkedException;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.ass.wsd/", "JAXBException"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://soap.ass.wsd/", "stackTraceElement"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
